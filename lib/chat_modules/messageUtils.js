...
// WHATSAPP_FALLBACK_PLACEHOLDER se pasará desde effectiveConfig

export function getWhatsappContactMessage(contactNumber, fallbackPlaceholder) {
...
export function getWhatsappDerivationSuffix(contactNumber, fallbackPlaceholder) {
    const wsp = String(contactNumber || '').trim();
   if (wsp && wsp !== fallbackPlaceholder && wsp !== "") {
