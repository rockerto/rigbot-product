...
export default async function validateRequest(req, res) { // <--- CAMBIO AQUÍ
  ...
  if (!message && req.method === 'POST') { // Asegurarse que el mensaje solo es obligatorio para POST reales, no OPTIONS
