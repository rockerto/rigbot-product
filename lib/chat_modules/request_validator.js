...
export async function validateRequest(req, res) {
  ...
  try {
    ...
    clientConfigDataFromFirestore = clientDocSnap.data(); // Renombrar para evitar confusión de scope
...
  }
  ...
  return {
    ...
    requestData: { message, sessionId: currentSessionId, clientId: requestClientId, ipAddress } 
  };
}